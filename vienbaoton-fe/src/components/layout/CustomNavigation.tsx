...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      { label: "Hoạt động Viện", href: "/tin-hoat-dong-vien" },
      { label: "Chỉ đạo Bộ", href: "/tin-chi-dao-bo" },
  ...
  },
  {
    ...
    children: [
      { label: "Cấp Nhà nước", href: "/de-tai-cap-nha-nuoc" },
      { label: "Cấp Bộ", href: "/de-tai-cap-bo" },
    ...
    children: [
      {
        ...
        children: [
          { label: "Lập hồ sơ khoa học", href: "/lap-ho-so-khoa-hoc" },
          { label: "Khảo sát – đánh giá", href: "/khao-sat-danh-gia" },
          { label: "Tu bổ – phục hồi", href: "/tu-bo-phuc-hoi" },
      ...
      },
      {
        ...
        children: [
          { label: "Chương trình đào tạo", href: "/gioi-thieu-chuong-trinh" },
      ...
      },
      {
        ...
        href: "/tra-cuu",
        children: [
          { label: "Tìm kiếm", href: "/tim-kiem-nhanh" },
          { label: "CSDL Di tích", href: "/csdl-di-tich" },
          { label: "CSDL Hồ sơ tu bổ", href: "/csdl-ho-so-tu-bo" },
          { label: "Ngân hàng hình ảnh", href: "/ngan-hang-hinh-anh" },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Gửi yêu cầu", href: "/form-gui-yeu-cau" },
      { label: "Phụ trách chuyên môn", href: "/phu-trach-chuyen-mon" },
    ],
  },
];
